...
function generateSaltSign() {
	var e = "FY_BY_REALTlME"
	var t = md5("5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.88 Safari/537.36")
	  , r = "" + (new Date).getTime()
